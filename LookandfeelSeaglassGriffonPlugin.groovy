 ...
 */
class LookandfeelSeaglassGriffonPlugin {
    // the plugin version
    ...
    String source = 'https://github.com/griffon/griffon-lookandfeel-seaglass-plugin'
    ...
    String title = 'Pluggable Look & Feel based on Seaglass'
    String description = '''
